...
mix.extract(["vue-router"], "js/vue-router");
mix.extract(["vuex"], "js/vuex");
mix.extract(["axios"], "js/axios");
mix.extract(["fontfaceobserver"], "js/fontfaceobserver");
mix.alias({
